<template>
  <div class="detail-wrap">
    ...
    <!--show join popup-->
    <div class="modal" id="join-induce-modal-wrap">
...
export default {
  ...
  methods: {
    showJoinPopup: function () {
      ...
      $('#join-induce-modal-wrap').modal('show').fadeIn
    },
    showJoinFooterPopup: function () {
      $('#join-induce-modal-footer-wrap').modal('show').fadeIn
    }
  }
}
</script>
